...
export default function Navbar(){
    return(
        ...
        <nav className="bg-gray-800">
                        ...
                        <div className="hidden sm:ml-6 sm:block">
                            <div className="flex space-x-4">
                                <Link href="/pages/todos">
                                    <p  className="bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium" aria-current="page">Metaverse</p>
                                </Link>
                                <Link href="/pages/home">
                                    <p  className="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Home</p>
                                </Link>
                                <Link href="/pages/about">
                                    <p  className="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">About</p>
                                </Link>
                                <Link href="/pages/contact">
                                    <p  className="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">contact</p>
                                </Link>
                            </div>
                        </div>
                    </div>
            ...
            {/*        <Link href={"/Contact"}>Contacts</Link></div>*/}
            {/*</div>*/}
        </nav>
)
}
