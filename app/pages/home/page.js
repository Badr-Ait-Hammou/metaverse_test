        ...
        <div >
            <div className="flex justify-between items-center py-3 px-5">
                <div className="w-1/2">
                    ...
                    <h3 className="text-2xl font-sans text-gray-50 mt-5">Mental health encompasses the overall well-being of an individual's emotional and psychological state. In South Africa, mental health disorders are prevalent, with the South African Stress and Health (SASH) study reporting that around 30% of the population will experience a mental disorder in their lifetime.</h3>
                </div>
                <div className="w-1/2">
                    <Image
                        src={img1}
